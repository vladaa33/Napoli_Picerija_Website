...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <div
      className={cn(
        "flex justify-center z-50 mb-6",
        className,
      )}
    >
      <div className="flex items-center gap-3 bg-gray-800/30 border border-gray-700/50 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
        {items.map((item) => {
          ...
          return (
            <a
              ...
              className={cn(
                ...
                isActive && "bg-gray-700/50 text-orange-500",
              )}
            >
