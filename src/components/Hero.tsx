...
export default function Hero({ onOrderClick, onCartClick, language }: HeroProps) {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-2 drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
            {language === 'sr' ? 'Tradicionalne recepte donosimo pravo do vaših vrata. Svaka pica, svaki obrok pripremljen sa ljubavlju i pažnjom. ❤️' : 'We bring traditional recipes right to your door. Every pizza, every meal prepared with love and care. ❤️'}
          </p>
