    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ✅ Properly formatted, multiline order items */}
          <input
            type="hidden"
            name="order_items"
            value={items
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Ulica i broj *</label>
              <input
                type="text"
                name="address"
                required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-300 mb-2">Grad *</label>
                <input
                  type="text"
                  name="city"
                  required
